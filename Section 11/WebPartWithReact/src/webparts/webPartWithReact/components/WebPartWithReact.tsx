...
export default class WebPartWithReact extends React.Component<
  IWebPartWithReactProps,
  {}
> {
  public render(): React.ReactElement<IWebPartWithReactProps> {
    ...
    return (
      <section
        className={`${styles.webPartWithReact} ${
        ...
        <div className={styles.welcome}>
          ...
          <div>
            Absolute URL: <strong>{escape(absoluteUrl)}</strong>
          </div>
          <div>
            Title: <strong>{escape(siteTitle)}</strong>
          </div>
          <div>
            Relative URL: <strong>{escape(relativeUrl)}</strong>
          </div>
          <div>
            User Name: <strong>{escape(userDisplayName)}</strong>
          </div>
        </div>
        <div>
